...
| `historian` | Memory/Continuity | knowledge-vault |
...
| `knowledge-vault` | Memory management |
| `sandbox-executor` | Docker isolation |
| `remote-bridge` | SSH/Remote execution |
...
| `/canvas` | Open visual dashboard |
| `/evolve` | Sync system capabilities |
