...
tech_02_utils = os.path.join(base_dir, "02_COGNITIVE_CORTEX", "utils")
if tech_02_utils not in sys.path:
    sys.path.insert(0, tech_02_utils)

from intent_schema_master import ToolIntent
