...
class KimiClient:
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: str = "https://api.moonshot.ai/v1"):
        ...
        if not self.api_key:
            raise ValueError("MOONSHOT_API_KEY not found. Please provide it or set it in .env.moonshot")
    ...
    async def chat_thinking(self, prompt: str, system_msg: str = "You are a professional assistant with deep thinking capabilities.") -> str:
        """
